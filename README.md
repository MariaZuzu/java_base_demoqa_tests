# Проект по автоматизации тестовых сценариев для сайта https://demoqa.com/
## :scroll: Содержание:
...
```
clean test -Dbrowser=$BROWSER -DtestSiteBaseUrl=$BASE_URL -DbrowserResolution=$BROWSER_SIZE -DremoteBrowserUrlLogin=$LOGIN -DremoteBrowserUrlPassword=$PASS -DremoteBrowserUrl=$REMOTE_BROWSER_URL -DbrowserVersion=$BROWSER_VERSION
```
